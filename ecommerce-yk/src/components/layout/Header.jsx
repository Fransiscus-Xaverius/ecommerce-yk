    ...
    <header className="bg-white shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <nav className="flex items-center justify-between py-4">
          ...
          {/* Logo */}
          <a className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent hover:scale-105 transition-transform duration-200" href="#">
            YONGKI KOMALADI
          </a>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-4">
          <ul className="space-y-2">
            {navigationItems.map((item, index) => (
              <li key={index}>
                <a href={item.href} className="block py-3 text-gray-700 hover:text-purple-600 transition-colors duration-200">
                  {item.label}
                </a>
              </li>
            ))}
