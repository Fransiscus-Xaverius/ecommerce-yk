...
const FeaturesSection = () => {
  const features = [
    {
      icon: <Truck className="h-5 w-5 text-milky-blue sm:h-6 sm:w-6 md:h-7 md:w-7" />,
      title: "Free Shipping",
      description: "Orders above Rp 500k",
      bgColor: "bg-milky-blue/10",
    },
    {
      icon: <Shield className="h-5 w-5 text-green-600 sm:h-6 sm:w-6 md:h-7 md:w-7" />,
      title: "Secure Payment",
      description: "100% Protected",
      bgColor: "bg-green-50",
    },
    {
      icon: <RefreshCw className="h-5 w-5 text-yellow-600 sm:h-6 sm:w-6 md:h-7 md:w-7" />,
      title: "Easy Returns",
      description: "30 Days Policy",
      bgColor: "bg-yellow-50",
    },
    {
      icon: <Phone className="h-5 w-5 text-red-600 sm:h-6 sm:w-6 md:h-7 md:w-7" />,
      title: "24/7 Support",
      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-4 md:px-6 lg:px-4">
        <div className="grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-4">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group rounded-lg p-3 text-center transition-all duration-300 hover:bg-gray-50 sm:p-4 md:p-6"
            >
              <div
